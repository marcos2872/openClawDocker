...
Leia o arquivo `.opencode/skills/excalidraw/SKILL.md` com a ferramenta `read` **antes de qualquer ação**.
...
```bash
cd .opencode/skills/excalidraw/references && uv run python render_excalidraw.py <caminho-do-arquivo.excalidraw>
```
...
- **Cores exclusivamente** da paleta em `.opencode/skills/excalidraw/references/color-palette.md`
